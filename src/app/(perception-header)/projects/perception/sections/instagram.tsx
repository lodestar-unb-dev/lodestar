  ...
  return (
    <section className="flex flex-col items-center gap-5 px-5 text-justify">
      ...
      <p className="text-unbBlack-100">
        One of the major motivations for carrying out the Perception project is
        to continue ongoing activities in the AlfaCrux mission, promoting
        ...
        environment, assembly, analysis, and management of user terminals, both
        fixed for environmental data collection applications and mobile for
        tracking unmanned aerial vehicles (UAVs) in environmental monitoring
        applications and 2) Research and analysis of reliability and its
        elements in the production of satellite data for environmental
        monitoring applications; development of new solutions for the management
        and processing of data obtained via satellite; and also proposed digital
        models for health monitoring and control of space mission data.
      </p>

      <p className="self-start text-unbBlack-100">
        In this context, we kindly invite you to take a moment of your time and
        check our recent activities and achievements!
      </p>
