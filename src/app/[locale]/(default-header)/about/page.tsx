    ...
    <Layout id="about">
      <main className="bg-unbBlack-10 text-unbBlue-400">
        <div className="bg-unbBlack-5">
          <section className="mx-auto flex max-w-280 flex-col items-start gap-6 px-5 py-10 min-[560px]:items-center min-[560px]:py-20">
        ...
        <section className="mx-auto flex max-w-280 flex-col gap-10 px-5 py-10 min-[560px]:gap-24 min-[560px]:py-20">
          <div className="flex flex-col gap-6 text-center min-[560px]:gap-12">
            <h2 className="text-unbBlue-400 text-4xl min-[560px]:text-6xl">
              {t('membersTitle')}
            </h2>
